...
int main()
{
   ...
   //    cout<<"Enter radius and height of cykinder";
   //    cin>>r>>h;
   ...
   // A person tries to withdraw money from an ATM.Check if the withdrawal amount is a multiple of 100 and account balance is sufficient.If both conditions are met, approve the withdrawal and also calculate the remaining balance Otherwise, reject it with an appropriate message.
...
//  A university provides scholarships based on marks and attendance.If marks >= 90 and attendance >= 75%, student gets 100% scholarship.If marks >= 80 and attendance >= 60%, student gets 50% scholarship.Otherwise, no scholarship.
